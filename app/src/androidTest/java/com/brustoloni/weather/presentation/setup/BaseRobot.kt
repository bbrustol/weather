...
open class BaseRobot {
    ...
    private fun getStringFromId(strRId : Int, strParam : String = "") : String{
    ...
    fun scrollRecyclerView(
        ...
        onView(withId(rViewId)).perform(adapter?.itemCount?.minus(1)?.let { RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(it) })
}